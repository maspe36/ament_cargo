...
/// TODO verify these are actually the correct paths
...
macro_rules! ament_package {
    () => {
        ...
        let create_resource_index = |marker_path: &PathBuf| -> io::Result<()> {
        ...
        let copy_package_xml = |src: &PathBuf, dest: &PathBuf| -> io::Result<()> {
